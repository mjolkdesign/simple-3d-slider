...
$.widget( 'ui.jcoverflip', {
	...
	_goTo: function( index, time, force, originalEvent ){
			...
			// fix tommy: remove class from all elements first
			items.removeClass('before-first');
			items.removeClass('before');
			items.removeClass('active');
			items.removeClass('after-first');
			items.removeClass('after');
			
			// fix tommy: add class to current element
			items.eq(current).addClass('active');
			
			// add class to elements that are before and after current el
			$('li.active').prevAll('li').addClass('before');
			$('li.active').nextAll('li').addClass('after');
			
			$('li.active').prev('li').addClass('before-first');
			$('li.active').next('li').addClass('after-first');
